...
<html>
    ...
    <body>
        <header>
            <p>Registro Local Caninoxxxx</p> 
        </header>
        
        <section>
            <a href="FormRegistrarPerro.php" target="_self"><img id="img" title="Registrar Mascota" src="archivos/consulta.gif" style="width:100px;height:80px;float:left;"></a>
            ...
            <form action="Consultar_perro.php" method="GET">
